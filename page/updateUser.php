                ...
                <div class="row">
                        ...
                        <form action="" method="post" id="updateUserForm">
                            ...
                            <div class="row">
                                <div class="col-12 my-2">
                                    <?= App\Form::text(trans('Email'), 'email', 'email', $UpdateUser->getEmail(), true, 60, 'aria-describedby="emailHelp"', '<small id="emailHelp" class="form-text text-muted">' . trans('En changeant votre adresse email vous serez déconnecté du logiciel') . '</small>'); ?>
                                </div>
                                <div class="col-12 my-2">
                                    <?= App\Form::text(trans('Nom'), 'nom', 'text', $UpdateUser->getNom(), true, 40); ?>
                                </div>
                                <div class="col-12">
                    ...
                    <div class="col-12 col-lg-6 my-2">
                        <form action="" method="post" id="updatePasswordUserForm" autocomplete="off">
                            ...
                            <div class="row">
                                <div class="col-12 my-2">
                                    <?= App\Form::text(trans('Nouveau Mot de passe'), 'password', 'password', 'password', true, 150, 'autocomplete="off"'); ?>
                                </div>

                                <div class="col-12 my-2">
                                    <?= App\Form::text(trans('Confirmation du Mot de passe'), 'password2', 'password', '', true, 150, 'autocomplete="off"'); ?>
                                </div>
                            </div>
                            <div class="my-2"></div>
                            <div class="row">
