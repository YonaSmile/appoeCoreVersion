    ...
    a.fn.pagination = function (e = {}) {
        ...
        if (n.length) {
            ...
            function i(e) {
                let i = "", s = e.length;
                if (s > r) {
                    let o = Math.floor(s / r), c = s % r, p = o;
                    if (o >= 1) for (let a = 1; a <= o; a++) i += '<li class="page-item"><a class="page-link" href="#' + a + '">' + a + "</a></li>";
                    c > 0 && (i += '<li class="page-item"><a class="page-link" href="#' + ++p + '">' + p + "</a></li>");
                    let g = 0;
                    e.each(function (e, t) {
                        e % r == 0 && g++, a(t).attr("data-page", "#" + g)
                    });
                    let f = '<nav aria-label="Page navigation" class="navPagination"><ul class="pagination justify-content-center"><li class="page-item"><a class="page-link" href="#prev" aria-label="Previous">' + t.previous + "</a></li> " + i + '<li class="page-item"><a class="page-link" href="#next" aria-label="Next">' + t.next + "</a></li> </ul></nav>";
                    a(f).insertAfter(n), l(e, "#1"), a(document.body).on("click", "a.page-link", function (t) {
