<div id="cookieInfo"
     style="position: fixed; bottom: 0; left: 0; width: 100%; padding: 10px; background: rgba(0,0,0,0.8); color: #FFF; box-sizing: border-box;z-index: 999999;text-align: left;">
    En poursuivant votre navigation sur ce site, vous acceptez l’utilisation de Cookies pour réaliser des statistiques
    de visites.
    <br>
