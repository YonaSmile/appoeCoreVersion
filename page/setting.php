    ...
    <div class="row" id="pluginsContainer">
        <div class="col-12 col-lg-6">
            ...
            if (is_array($plugins) && !empty($plugins)) : ?>
                <h4 class="py-3 border border-right-0 border-top-0 border-left-0 text-uppercase"><?= trans('Plugins'); ?></h4>
                <div class="row">
        ...
        <div class="col-12 col-lg-6">
            <h4 class="py-3 border border-right-0 border-top-0 border-left-0 text-uppercase">
                <?= trans('Système'); ?>
            </h4>
            <div class="row">
                ...
                <div class="col-12" id="pluginSystemContenair" style="display: none">
                    ...
                    <div class="p-2 mb-2 bg-light">
                        <button type="button" id="updatePlugins" class="btn btn-warning btn-sm operationBtn">
                            <?= trans('Mettre à jour'); ?>
                        </button>
                    </div>
                    <div class="my-4"></div>
