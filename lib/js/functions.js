...
!function (a) {
    a.fn.pagination = function (e = {}) {
        let t = {container: ".articles", categoriesBtnData: "data-category", items: 6};
        jQuery.extend(t, e);
        let n = a(t.container);
        if (n.length) {
            let e = "[" + t.categoriesBtnData + "]", s = a(e), r = t.items;

            function i(e) {
                let t = "", i = e.length;
                if (i > r) {
                    let s = Math.floor(i / r), o = i % r, c = s;
                    if (s >= 1) for (let a = 1; a <= s; a++) t += '<li class="page-item"><a class="page-link" href="#' + a + '">' + a + "</a></li>";
                    o > 0 && (t += '<li class="page-item"><a class="page-link" href="#' + ++c + '">' + c + "</a></li>");
                    let p = 0;
                    e.each(function (e, t) {
                        e % r == 0 && p++, a(t).attr("data-page", "#" + p)
                    }), a('<nav aria-label="Page navigation" class="navPagination"><ul class="pagination justify-content-center"><li class="page-item"><a class="page-link" href="#prev" aria-label="Previous"><span aria-hidden="true">&laquo;</span></a></li> ' + t + '<li class="page-item"><a class="page-link" href="#next" aria-label="Next"><span aria-hidden="true">&raquo;</span></a></li> </ul></nav>').insertAfter(n), l(e, "#1"), a(document.body).on("click", "a.page-link", function (t) {
                        t.preventDefault(), t.stopPropagation();
                        let i = a(this).attr("href");
                        if ("#prev" !== i && "#next" !== i) a(this).hasClass("active") || (l(e, i), a("html, body").animate({scrollTop: parseInt(a(n).offset().top) - 150}, 500)); else {
                            let t = parseInt(a("a.page-link.active").attr("href").substring(1));
                            "#prev" === i ? a('a.page-link[href="#' + (t - 1) + '"]').length && (l(e, "#" + (t - 1)), a("html, body").animate({scrollTop: parseInt(a(n).offset().top) - 150}, 500)) : "#next" === i && a('a.page-link[href="#' + (t + 1) + '"]').length && (l(e, "#" + (t + 1)), a("html, body").animate({scrollTop: parseInt(a(n).offset().top) - 150}, 500))
                        }
                    })
                } else e.fadeIn()
            }
            ...
            function l(e, t = "") {
                e.hide(), a("a.page-link").removeClass("active"), "" !== t && (a('a.page-link[href="' + t + '"]').addClass("active"), a('[data-page="' + t + '"]', n).fadeIn())
            }

            i(n.children()), s.length && a(document.body).on("click", e, function (e) {
                e.preventDefault(), e.stopPropagation();
                let l = a(this), r = l.attr(t.categoriesBtnData);
                l.hasClass("active") || (s.removeClass("active"), l.addClass("active"), n.children().hide().removeClass("showByCategory").removeAttr("data-page"), a("nav.navPagination").remove(), "all" === r ? i(n.children()) : (a("[data-filter*=" + r + "]", n).addClass("showByCategory"), i(a(".showByCategory", n))))
            })
        }
    }
}(jQuery);