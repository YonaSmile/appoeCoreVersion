...
function appoEditor() {
    ...
    if ($('textarea.appoeditor')) {
        ...
        $('.appoeditor').each(function (num, el) {
            ...
            //NAVBAR
            var btnNav = $('<nav class="navButton navbar navbar-text navbar-light bgColorSecondary" data-editor-id="' + newId + '"></nav>');
            ...
            var selectFormat = [
                ...
                'data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Format</button>' +
                ...
                'data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Edition</button>' +
