            ...
            if (strlen($email) < 40 && strlen($pass) < 20) {
                ...
                if (filter_var($email, FILTER_VALIDATE_EMAIL)) {
                    ...
                    if (!$User->authUser()) {
                        ...
                        $_SESSION['auth'] = $User->getId() . '351ab51c2d33efb942cab11f25cdc517a84df66bc51ffe1f2beb!a6fgcb!f152ddb3!6ff2cd41abd35df42cbb21a' . sha1($User->getEmail() . $_SERVER['REMOTE_ADDR']);
