    ...
    if ($('textarea.appoeditor')) {
        ...
        $('.appoeditor').each(function (num, el) {
            ...
            var buttons = {
                ...
                buttonsMedia: [
                    '<button type="button" data-id-modal="insertImg" class="openModalEditor noSelection btnEditor btn btn-secondary" title="Ajouter une image"><i class="far fa-image"></i></button>'
                ]
            };
