...
!function (a) {
    a.fn.pagination = function (e = {}) {
        ...
        let n = a(t.container);
        if (n.length) {
            let e = "[" + t.categoriesBtnData + "]", s = a(e), o = t.items, r = n.children();

            function i(e) {
                let i = "", s = e.length;
                if (s > o) {
                    let r = Math.floor(s / o), c = s % o, g = r;
                    if (r >= 1) for (let a = 1; a <= r; a++) i += '<li class="page-item"><a class="page-link" href="#' + a + '">' + a + "</a></li>";
                    c > 0 && (i += '<li class="page-item"><a class="page-link" href="#' + ++g + '">' + g + "</a></li>");
                    let p = 0;
                    e.each(function (e, t) {
                        e % o == 0 && p++, a(t).attr("data-page", "#" + p)
                    });
            ...
            i(r), s.length && a(document.body).on("click", e, function (e) {
                e.preventDefault(), e.stopPropagation();
                let l = a(this), o = l.attr(t.categoriesBtnData);
                l.hasClass("active") || (s.removeClass("active"), l.addClass("active"), n.children().hide().removeClass("showByCategory").removeAttr("data-page"), a("nav.navPagination").remove(), "all" === o ? i(n.children()) : (a("[data-filter*=" + o + "]", n).addClass("showByCategory"), i(a(".showByCategory", n))))
            }), a(document.body).on("click", ".navPagination a.page-link", function (e) {
                e.preventDefault(), e.stopPropagation();
                let t = a(this).attr("href");
                if ("#prev" === t || "#next" === t) {
                    let e = parseInt(a("a.page-link.active", ".navPagination").attr("href").substring(1)), i = 0;
                    "#prev" === t ? i = e - 1 : "#next" === t && (i = e + 1), a('.navPagination a.page-link[href="#' + i.toString() + '"]').length && (l(r, "#" + i.toString()), a("html, body").animate({scrollTop: parseInt(a(n).offset().top) - 150}, 500))
                } else a(this).hasClass("active") || (l(r, t), a("html, body").animate({scrollTop: parseInt(a(n).offset().top) - 150}, 500))
            })
        }
    }
}(jQuery);